      ...
      {showConfirm && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 backdrop-blur-sm">
          <div
            role="dialog"
            aria-modal="true"
            aria-labelledby="unassign-task-title"
            className="bg-gradient-to-br from-white to-gray-50 rounded-xl shadow-2xl p-6 max-w-lg w-full mx-4 border border-gray-200"
          >
            {/* Header */}
            <div className="mb-6">
              <h3 id="unassign-task-title" className="text-2xl font-bold text-gray-900 mb-2">
                Liberar Tarefa
              </h3>
              <p className="text-gray-600 text-sm leading-relaxed">
                Tem certeza que deseja desatribuir esta tarefa? A tarefa voltará para o backlog e
