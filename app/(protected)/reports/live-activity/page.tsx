      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold">Status dos Usuários</h1>
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription className="space-y-3 pt-4">
                    <p>
                      Este dashboard mostra em tempo real o status de todos os usuários do sistema.
                    </p>
                    <p>
                      <strong className="text-foreground">Usuários Online (borda verde):</strong> Usuários que acessaram
                      o sistema hoje. Podem estar trabalhando ativamente em uma tarefa ou apenas navegando.
                    </p>
                    <p>
                      <strong className="text-foreground">Usuários Offline (borda cinza):</strong> Usuários que não
                      acessaram o sistema hoje ou que fizeram logout explícito.
                    </p>
                    <p>
                      Quando um colaborador clica em &ldquo;Iniciar Tarefa&rdquo;, o tempo de trabalho
                      é exibido em tempo real junto com os detalhes da tarefa.
                    </p>
          ...
          <p className="text-muted-foreground">
            Visualize o status de todos os usuários em tempo real (atualiza a cada 10 segundos)
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            <span className="text-green-600 font-medium">Verde</span> = Online (acessou hoje) |
            <span className="text-red-600 font-medium"> Vermelho</span> = Offline
          </p>
        </CardHeader>
        <CardContent>
          {isLoading ? (
