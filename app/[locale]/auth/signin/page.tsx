        ...
        <div className="mt-10 space-y-6">
          ...
          >
            <SubmitButton
              ...
              className="w-full flex justify-center gap-3 py-3.5 px-4 rounded-lg shadow-md text-base font-semibold text-primary-foreground bg-primary hover:bg-primary/90 focus:outline-none focus:ring-4 focus:ring-primary/10 transition-all duration-200 hover:shadow-lg"
              icon={
